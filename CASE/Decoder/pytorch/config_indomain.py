...
def create_parser():
    ...
    parser.add_argument('--data_dir',
                        type=str,
                        default='lora_indoor_config',
                        help='Choose the root path to rf signals.',
                        choices=['simu_config','nophase_indoor_config','lora_indoor_config','indoor_cross_domain','lora_outdoor','lora_outdoor_trace'])

    parser.add_argument('--network', type=str, default='end2end',choices=['end2end','end2end_contrastive','end2end_outdoor'])
